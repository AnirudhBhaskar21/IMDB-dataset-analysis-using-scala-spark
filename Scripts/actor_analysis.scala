val movieRdd = sc.textFile("IMDB_dataset.csv")
...
val act_r = actor_dataF.map{case(act1n,act2n,act3n,imdb,fb,cast,nvr) => (act1n,(imdb,fb,nvr,1))}
...
val act_rat = act_r.reduceByKey{case ((pr1,prr1,prrr1,count1),(pr2,prr2,prrr2,count2)) => (pr1+pr2,prr1+prr2,prrr1+prrr2,count1+count2)}.map{l => (l._1,l._2._1/l._2._4,l._2._2/l._2._4,l._2._3/l._2._4)}
